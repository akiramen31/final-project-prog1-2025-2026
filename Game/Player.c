...
void LoadPlayer(void)
{
	...
	player.walkSound = CreateSound(GetAsset("Assets/Sounds/walk.ogg"), 0.5f, sfFalse);
	player.jumpSound = CreateSound(GetAsset("Assets/Sounds/lumora_studios-pixel-jump-319167.ogg"), 0.25f, sfFalse);
	player.hitSound = CreateSound(GetAsset("Assets/Sounds/sumaga123-metallic-thud-447690.ogg"), 0.5f, sfFalse);
	player.cutSound = CreateSound(GetAsset("Assets/Sounds/alexis_gaming_cam-katana-370403.ogg"), 0.2f, sfFalse);
	player.shootSound = CreateSound(GetAsset("Assets/Sounds/universfield-gunshot-352466.ogg"), 0.5f, sfFalse);
}
