...
<tileset version="1.10" tiledversion="1.12.1" name="Metal_girder" tilewidth="16" tileheight="16" tilecount="16" columns="4">
 <image source="Metal_girder.png" width="64" height="64"/>
 <wangsets>
  <wangset name="Jeu de Tuiles Sans Nom" type="edge" tile="0">
   <wangcolor name="Girder" color="#ff0000" tile="-1" probability="1"/>
